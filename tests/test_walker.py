...
class WalkerCheck:
    ...
    def test_prev(self):
        tree = self.get_tree(testitems)
        item = tree.prev_item(8)
        self.assertEqual(item[0], 7)
        item = tree.prev_item(6)
        self.assertEqual(item[0], 5)
        item = tree.prev_item(12)
        self.assertEqual(item[0], 10)
        item = tree.prev_item(10)
        self.assertEqual(item[0], 8)

    def test_succ(self):
        tree = self.get_tree(testitems)
        item = tree.succ_item(7)
        self.assertEqual(item[0], 8)
        item = tree.succ_item(10)
        self.assertEqual(item[0], 12)
        item = tree.succ_item(20)
    ...
    def test_floor_item(self):
        ...
        with self.assertRaises(KeyError):
            tree.floor_item(0)
        self.assertEqual(tree.floor_item(2)[0], 1)
        self.assertEqual(tree.floor_item(3)[0], 3)
        self.assertEqual(tree.floor_item(8)[0], 8)
        self.assertEqual(tree.floor_item(9)[0], 8)
        self.assertEqual(tree.floor_item(11)[0], 10)
        self.assertEqual(tree.floor_item(13)[0], 12)
        self.assertEqual(tree.floor_item(14)[0], 12)
        self.assertEqual(tree.floor_item(16)[0], 15)
        self.assertEqual(tree.floor_item(21)[0], 20)
        self.assertEqual(tree.floor_item(31)[0], 30)

    def test_ceiling_item(self):
        tree = self.get_tree(testitems)
        with self.assertRaises(KeyError):
            tree.ceiling_item(50)
        self.assertEqual(tree.ceiling_item(30)[0], 30)
        self.assertEqual(tree.ceiling_item(29)[0], 30)
        self.assertEqual(tree.ceiling_item(19)[0], 20)
        self.assertEqual(tree.ceiling_item(13)[0], 15)
        self.assertEqual(tree.ceiling_item(11)[0], 12)
        self.assertEqual(tree.ceiling_item(10)[0], 10)
        self.assertEqual(tree.ceiling_item(9)[0], 10)
        self.assertEqual(tree.ceiling_item(8)[0], 8)
        self.assertEqual(tree.ceiling_item(2)[0], 3)
        self.assertEqual(tree.ceiling_item(1)[0], 1)
        self.assertEqual(tree.ceiling_item(0)[0], 1)
